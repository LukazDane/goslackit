...
/*
   ...
   in the Slack API UI
*/
const helpMessage = "type in 'PokéBot <command_arg>'"
...
func getPoke() []string {
	return []string{"random", "pokemon", "r"}
}
...
// CreateSlackClient makes a client
...
// RespondToEvents responds to events
